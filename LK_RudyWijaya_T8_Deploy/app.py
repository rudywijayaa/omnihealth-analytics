...
st.markdown("""
    ...
    /* Menargetkan kontainer input & select bawaan Streamlit saat aktif */
    div[data-baseweb="input"]:focus-within, 
    div[data-baseweb="select"]:focus-within {
        border-color: #1E3A8A !important;
        /* Mengganti box-shadow oranye bawaan menjadi biru premium tanpa merusak tombol */
...
@st.cache_resource
def load_artefak():
    # Menggunakan os.path agar path file otomatis menyesuaikan environment server Linux saat deploy
