...
st.markdown("""
    ...
    /* Memaksa seluruh teks label input tetap berwarna gelap/terbaca */
    label, .stWidgetLabel p {
        color: #334155 !important;
        font-weight: 500 !important;
    }

    /* Memaksa warna latar belakang kolom input numerik & selectbox tetap terang */
    ...
    /* Mengubah warna tombol plus minus pada number input agar tetap kontras */
